...
They're made of MDF, which is cheap, cuts/sands to shape easily, and can withstand press pressure.
...
Pressure is then applied to the skis from the top using clamps or weight.
The weight can be from sandbags, buckets of water, or even a vehicle driven on top of the press.

This press design is the easiest and cheapest to build, but it outputs a relatively low amount of pressure, which can cause the final ski to not laminate properly.

#### Vacuum Press
This press works by placing the ski on top of the bottom section of a mold and covered in an air-tight film.
...
Some pneumatic presses use fire hoses as the bladder.
